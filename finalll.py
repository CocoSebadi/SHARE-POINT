...
def send_email(recipient_email, subject, body):
    # Placeholder: Print email details instead of actual sending
...
def main():
    ...
    if st.button("Login"):
        if len(employee_number) == 7 and validate_employee_number(employee_number):
            ...
            # Proceed with the issues form only after successful login
